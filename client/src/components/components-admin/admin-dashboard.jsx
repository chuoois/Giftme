...
export const AdminDashboard = () => {
    const analyticsData = {
        ...
        pageViews: [
            { date: "2024-01-01", views: 1200, sessions: 450 },
            { date: "2024-01-02", views: 1350, sessions: 520 },
            { date: "2024-01-03", views: 1100, sessions: 380 },
            { date: "2024-01-04", views: 1450, sessions: 600 },
            { date: "2024-01-05", views: 1600, sessions: 680 },
            { date: "2024-01-06", views: 1300, sessions: 550 },
            { date: "2024-01-07", views: 1750, sessions: 720 },
        ],
        deviceTypes: [
        ...
        topPages: [
            { page: "/", views: 15200, percentage: 34 },
            { page: "/combo", views: 12800, percentage: 28 },
            { page: "/news", views: 8900, percentage: 20 },
            { page: "/contact", views: 4300, percentage: 10 },
        ],
    };
        ...
        <div className="p-6 overflow-auto flex-1 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{analyticsData.totalStats.totalPageViews.toLocaleString()}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{analyticsData.totalStats.totalSessions.toLocaleString()}</div>
                        <p className="text-xs text-muted-foreground">
                            ...
                            {analyticsData.topPages.map((page, index) => (
                                <div key={index} className="flex items-center justify-between">
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-muted-foreground">{page.views.toLocaleString()} lượt xem</div>
                                    </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="text-2xl font-bold text-orange-600">
                                        {analyticsData.totalStats.newUsers.toLocaleString()}
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="text-sm text-muted-foreground">Người dùng quay lại</div>
                                    <div className="text-2xl font-bold text-blue-600">
                                        {analyticsData.totalStats.returningUsers.toLocaleString()}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="w-full bg-muted rounded-full h-2">
                                    <div
                                        ...
                                        style={{
                                            width: `${(analyticsData.totalStats.newUsers / (analyticsData.totalStats.newUsers + analyticsData.totalStats.returningUsers)) * 100}%`,
                                        }}
                                    />
                                </div>
                            </div>
