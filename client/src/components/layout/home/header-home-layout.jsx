              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <svg
                    ...
                    className="w-4 h-4 text-black cursor-pointer hover:text-pink-500"
                    viewBox="0 0 448 512"
                    fill="currentColor"
                  >
                    <path d="M448,209.9c-16.6,7.3-34.4,12.2-53.2,14.4c19.1-11.5,33.7-29.7,40.6-51.5c-17.9,10.6-37.8,18.3-59,22.4
                    c-16.9-18-41-29.3-67.7-29.3c-51.2,0-92.8,41.6-92.8,92.8c0,7.3,0.8,14.4,2.4,21.2c-77.1-3.9-145.5-40.8-191.3-96.9
                    c-8,13.8-12.6,29.7-12.6,46.7c0,32.2,16.4,60.7,41.4,77.4c-15.2-0.5-29.6-4.7-42.1-11.7c0,0.4,0,0.8,0,1.2
                    c0,45,32,82.5,74.5,91c-7.8,2.1-16.1,3.2-24.6,3.2c-6,0-11.9-0.6-17.6-1.6c11.9,37.1,46.4,64.2,87.3,65
                    c-32,25.1-72.3,40.1-116,40.1c-7.5,0-14.9-0.4-22.2-1.3c41.4,26.5,90.6,41.9,143.5,41.9c172.2,0,266.4-142.6,266.4-266.4
